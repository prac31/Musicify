...
import com.example.WikiMusic.model.Tag
import com.example.WikiMusic.model.TopTagResponse
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val response = Retrofit.api.getTopTags()
Toast.makeText(this,"loading...",Toast.LENGTH_SHORT).show()
    ...
    private fun refreshtheList() {
        ...
        for (i in 1 until tagList.size) {
            ...
            chip.setChipBackgroundColorResource(R.color.red_dark)

            chip.setOnClickListener {
                val intent = Intent(this, GenreDetail::class.java)
